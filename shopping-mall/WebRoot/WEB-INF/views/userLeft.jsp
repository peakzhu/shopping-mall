	...
	<div id="container" style='height:700px;'>
		<div class="w">
			<div id="myjd-shortcut">
				<dl class="myjd-set">
					<dd>
						<a href="#" onclick="changeframe('user/userManager.shtml')"><span>个人信息</span></a>
				...
				<div id="left" class="g-3-5 c-0">
					<div id="menu-new">
						<dl><dt id="_MYJD_setting">设置</dt>
							<dd class="fore1" onclick="changeframe('user/userManager.shtml')"><div class="item curr" id="_MYJD_info"><a>个人信息</a></div></dd>
							<dd class="fore2"><div class="item" id="_MYJD_safe"><a>账户安全</a></div></dd>
