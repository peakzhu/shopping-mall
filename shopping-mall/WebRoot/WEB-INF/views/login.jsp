		...
		$.ajax({
			...
			success:function(data){
				if(data.code!=1){
					...
					if(type==1){
						window.location.href="getUserIndex.shtml";
					}else{
						window.location.href="getCompanyUserIndex.shtml";
					}
				}
			}
		});
			...
			<form action="login/login.shtml" id="login-form" method="post">
				<div class="login_box" style="filter:alpha(opacity=50)">
					...
					<div class="password_tishi">
						<input type="radio" name='type' value='1'>个人<input type="radio" name='type' value='2'>企业&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					</div>
					<div class="username">
					...
					<div class="password_tishi">
						...
						<a class="black01" style="float: right;"><img id="imgCode" onclick="imgUpdate()"
							src="/shopping-mall/code/captcha-image" width="100" height="40" /></a>
					</div>
					<div id="errormsg"
